package com.dreams.oauth2.support;
...
public class RedisUtils {
    ...
    static {
        stringRedisTemplate = Util.getBean(StringRedisTemplate.class);
    }
    ...
    static <T> T toBeanOrNull(String json, Class<T> tClass) {
        return json == null ? null : JsonUtils.jsonCovertToObject(json, tClass);
    }

    public static String objToStr(Object o) {
        return JsonUtils.objectCovertToJson(o);
    }
