package com.dreams.oauth2.property;
...
import static com.dreams.oauth2.property.CustomSecurityProperties.PREFIX;

/**
 * Description: 自定义安全配置属性
 *
 * @author luoan
 * @since 2023/10/25
 */
...
public class CustomSecurityProperties {
     ...
     * 错误e.g. http://当前项目IP:当前项目端口/sign-in
     */
    private String signInPageUri = "/sign-in";
    /**
     * 授权确认页面
     * 注意：不是前后端分离的项目不要写完整路径，当前项目部署的IP也不行！！！
     ...
     */
    private String deviceActivatePageUri = "/activate";
    /**
     * 授权码验证页面
     * 注意：不是前后端分离的项目不要写完整路径，当前项目部署的IP也不行！！！
     * 错误e.g. http://当前项目IP:当前项目端口/activated
