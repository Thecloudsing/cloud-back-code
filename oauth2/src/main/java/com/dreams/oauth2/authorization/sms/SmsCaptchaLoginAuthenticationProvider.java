package com.dreams.oauth2.authorization.sms;

import com.dreams.oauth2.authorization.captcha.CaptchaAuthenticationProvider;
...
import static com.dreams.oauth2.constant.RedisConstants.SMS_CAPTCHA_PREFIX_KEY;
...
//            String smsCaptcha = redisOperator.get((SMS_CAPTCHA_PREFIX_KEY + authentication.getPrincipal()));
            String smsCaptcha = RedisUtils.get((SMS_CAPTCHA_PREFIX_KEY + authentication.getPrincipal()), String.class);
...
//            redisOperator.delete((SMS_CAPTCHA_PREFIX_KEY + authentication.getPrincipal()));
            RedisUtils.del((SMS_CAPTCHA_PREFIX_KEY + authentication.getPrincipal()));
