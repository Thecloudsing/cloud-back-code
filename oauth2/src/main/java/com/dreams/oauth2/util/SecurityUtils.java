...
import com.dreams.oauth2.authorization.device.DeviceClientAuthenticationConverter;
import com.dreams.oauth2.authorization.device.DeviceClientAuthenticationProvider;
import com.dreams.oauth2.authorization.handler.ConsentAuthenticationFailureHandler;
import com.dreams.oauth2.authorization.handler.ConsentAuthorizationResponseHandler;
import com.dreams.oauth2.authorization.handler.DeviceAuthorizationResponseHandler;
import com.dreams.oauth2.authorization.handler.LoginTargetAuthenticationEntryPoint;
        ...
        http
                ...
                .exceptionHandling((exceptions) -> exceptions
                        .defaultAuthenticationEntryPointFor(
                                new LoginTargetAuthenticationEntryPoint(customSecurityProperties.getSignInPageUri(), customSecurityProperties.getDeviceActivatePageUri()),
    ...
    public static void applyDeviceSecurity(HttpSecurity http,
        ...
        http.getConfigurer(OAuth2AuthorizationServerConfigurer.class)
                ...
                .deviceAuthorizationEndpoint(deviceAuthorizationEndpoint ->
                        deviceAuthorizationEndpoint.verificationUri(UrlUtils.isAbsoluteUrl(customSecurityProperties.getDeviceActivatedPageUri()) ? CUSTOM_DEVICE_REDIRECT_URI : customSecurityProperties.getDeviceActivatePageUri())
                )
                // 设置验证设备码用户确认页面
                .deviceVerificationEndpoint(deviceVerificationEndpoint -> {
                            ...
                            if (UrlUtils.isAbsoluteUrl(customSecurityProperties.getDeviceActivatePageUri()) || absoluteUrl) {
                                // 添加响应json处理
                                deviceVerificationEndpoint.deviceVerificationResponseHandler(new DeviceAuthorizationResponseHandler(customSecurityProperties.getDeviceActivatedPageUri()));
                            }
                        }
                )
